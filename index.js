...
const burger = {
  ...
  discount: function(person){
    if(person === `student`){
      return thid.price - (this.price * 0.25);
...
function getLastReview(array) {
  return `${array[array.length -1].name} gave the restaurant a ${array[array.length -1].rating} 3.5 star review, and their feedback was: ${array[array.length -1].feedback}`;
  } 
